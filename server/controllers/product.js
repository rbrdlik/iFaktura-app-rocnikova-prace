...
exports.getAllUserProduct = async (req, res) => {
    try {
        ...
        if(!products) return res.status(404).json({ message: "Produkty nenalezeny" })
...
exports.getUserProductById = async (req, res) => {
    try{
        ...
        if(product.user_id.toString() !== req.user.userId) return res.status(404).json({ message: "Produkt nebyl nalezen" })
...
exports.updateProduct = async (req, res) => {
    try{
        ...
        if(product.user_id.toString() !== req.user.userId) return res.status(404).send({ message: "Produkt nenalezen."})
